...
public class ConnectionAcceptor<T> {
     ...
     * @param data      a reference to ReactorData object
     */
     ...
     * </UL>
     *
     * @throws IOException in case of an IOException during the acceptance of a new
     *                     connection
     */
    ...
    public void accept() throws IOException {
        ...
        if (sChannel != null) {
            ...
            logger.info("Accepted a connection from " + address);
